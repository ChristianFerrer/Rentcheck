  ...
  if (showManual) {
    return (
      <div className="mt-8 animate-fade-in">
        {scrapeError && (
          <div className="max-w-2xl mx-auto mb-4 rounded-lg bg-amber-50 border border-amber-200 overflow-hidden">
            <div className="p-3 flex items-start gap-2 text-sm text-amber-800">
